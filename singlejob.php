          ...
          <div class="row row-30 justify-content-between">
            <div class="col-md-6 col-xl-7">
              <ul class="list-xxl">
                ...
                <li><a class="button button-lg button-primary" href="#">Submit CV</a></li>
              </ul>
            </div>
            <div class="col-sm-9 col-md-6 col-lg-5 col-xl-4">
              <div class="box-wrap-gray">
                <div class="thumbnail-1">
                  <div class="media-wrap"><img src="images/single-job-270x270.jpg" alt="" width="270" height="270"/>
                  </div>
                  <div class="title"><a href="#">Deborah Mitchell</a></div>
