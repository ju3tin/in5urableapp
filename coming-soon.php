      ...
      <section class="section one-screen-page bg-primary-dark">
        <div class="one-screen-page-inner">
          <div class="page-header">
            <div class="container">
              <!-- Brand--><a class="brand" href="index.html"><img class="brand-logo-dark" src="images/logo-84x23.png" alt="" width="84" height="23"/><img class="brand-logo-light" src="images/logo-inverse-84x23.png" alt="" width="84" height="23"/></a>
            </div>
          </div>
              ...
              <div class="row justify-content-center">
                <div class="col-md-10 col-xl-8">
                  <div class="one-screen-page-box">
                    <h1 class="page-subtitle">We're Getting Ready to Launch In</h1>
                    <div class="countdown-wrap block-centered">
                      <!-- TimeCircles-->
                      <div class="DateCountdown" data-date="2018-10-01 00:00:00" data-width="0.015" data-bg-width="0.5" data-bg="#fff" data-color="#5428a4"></div>
                    </div>
                    <p class="heading-6 page-description">Our website is under construction, we are working very hard to give you the best experience on our new web site. Stay ready, we`re launching soon.</p>
                    <div class="block-sm">
                      <!-- RD Mailform-->
