              ...
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-11">
                  <div class="one-screen-page-box">
                    ...
                    <h1 class="page-subtitle">Service is Temporary Unavailable</h1>
                    <p class="heading-6 page-description">Sorry, we're offline right now to make our site even better. Please, come back later and check what we've been up to.</p><a class="button button-lg button-primary" href="index.html">Back to home page</a>
                  </div>
                </div>
              </div>
            </div>
