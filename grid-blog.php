            ...
            <div class="col-md-6 col-lg-4">
              <article class="post-boxed">
                ...
                <div class="post-body">
                  ...
                  <p class="post-exeption">Lorem ipsum dolor sit amet, scripta legimus quaerendum ex vis, audire nonumes his an. Decore tamquam insolens usu, an duo omnium debitis.</p>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-lg-4">
