  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="section section-bredcrumbs">
        <div class="container context-dark breadcrumb-wrapper">
          ...
          <ul class="breadcrumbs-custom">
            ...
            <li class="active">Modern blog</li>
          </ul>
        </div>
      </section>
      <!-- Overview-->
      <section class="section section-lg bg-gray-100">
        <div class="container">
          <div class="post-modern-wrap">
            <div class="post-modern-left">
              <div class="post-modern-item">
                <article class="post-modern">
                  ...
                  <div class="post-body">
                    ...
                    <p class="post-exeption">Lorem ipsum dolor sit amet, scripta legim us quaerendum ex vis, audire nonumes his an. Decore tamquam insolens usu, an.</p>
            ...
            <div class="post-modern-right">
              ...
              <div class="post-modern-item">
                <article class="post-modern">
                  <div class="media-wrapper"><a href="single-post.html"><img src="images/modern-blog-4-370x240.jpg" alt="" width="370" height="240"/></a>
                    <ul class="list-tags">
                      <li><a class="tag" href="single-post.html">Banks</a>
                      </li>
                    </ul>
                  ...
                  <div class="post-body">
                    <div class="post-author"><a class="img-author" href="single-post.html"><img src="images/modern-author-4-72x72.jpg" alt="" width="72" height="72"/></a>
                      <div class="post-author-name">Theresa Simpson</div>
                    </div>
                    <h5 class="post-title"><a href="single-post.html">Cash Faces a New Challenger in Zelle, a Mobile Banking Service</a></h5>
                    <p class="post-exeption">Lorem ipsum dolor sit amet, scripta legim us quaerendum ex vis, audire nonumes his an. Decore tamquam insolens usu, an.</p>
                    <div class="post-date">May, 23 2018, at 8:49 am</div>
                  </div>
                </article>
          ...
          <div class="post-button-wrap text-center"><a class="button button-lg button-primary" href="#">Load More Blog Posts</a></div>
        </div>
      </section>
      <!-- Page Footer-->
