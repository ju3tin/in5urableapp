    ...
    <div class="page">
      ...
      <section class="section swiper-container swiper-slider swiper-slider-2" data-loop="true" data-autoplay="5000" data-simulate-touch="false" data-slide-effect="fade">
        <div class="swiper-wrapper text-center">
          <div class="swiper-slide context-dark" data-slide-bg="images/slider-4-1920x1000.jpg">
            <div class="swiper-slide-caption">
              <div class="container">
                <div class="row justify-content-lg-center">
                  <div class="col-md-12 col-xl-10">
                    <h1 data-caption-animate="fadeInUp" data-caption-delay="100">Where You Know Your Banker and Your Banker Knows You</h1><a class="button button-lg button-primary" href="about.html" data-caption-animate="fadeInUp" data-caption-delay="450">Learn More</a>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div class="swiper-slide context-dark" data-slide-bg="images/slider-5-1920x1000.jpg" style="background-position: 50% 50%;">
            <div class="swiper-slide-caption">
              <div class="container">
                <div class="row justify-content-lg-center">
                  <div class="col-md-12 col-xl-10">
                    <h1 data-caption-animate="fadeInUp" data-caption-delay="100">Our Quest to Make Banking Better Starts Here</h1><a class="button button-lg button-primary" href="about.html" data-caption-animate="fadeInUp" data-caption-delay="450">Learn More</a>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div class="swiper-slide context-dark" data-slide-bg="images/slider-6-1920x1000.jpg" style="background-position: 50% 50%;">
            <div class="swiper-slide-caption">
              <div class="container">
                <div class="row justify-content-lg-center">
                  <div class="col-md-12 col-xl-10">
                    <h1 data-caption-animate="fadeInUp" data-caption-delay="100">The Fastest Way to Send Money Worldwide</h1><a class="button button-lg button-primary" href="about.html" data-caption-animate="fadeInUp" data-caption-delay="450">Learn More</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row row-flex no-gutters">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="blurb-boxed-2 blurb-boxed-dark">
              <div class="icon mdi mdi-cash"></div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="blurb-boxed-2 blurb-boxed-darker">
              <div class="icon mdi mdi-credit-card-multiple"></div>
              <h6 class="title">Up to <span class="font-weight-bold">25%</span> for Deposit</h6>
              <p class="exeption">Dot Bank offers various deposit offers in all international currencies with interest rate up to 25% for all regular clients.</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="blurb-boxed-2 blurb-boxed-darkest">
              <p class="exeption">The Best Choice 2018</p>
              <h5 class="title">Reliable and Secure Credit Cards and Deposits for You</h5><a class="button button-lg button-icon button-icon-left button-primary" href="#"><span class="icon mdi mdi-credit-card"></span>Book a Card</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="section section-lg bg-gray-100">
        <div class="container">
          <div class="block-lg text-center">
            ...
            <p>Dot Bank was founded in 1999 to introduce the new level of financial services worldwide. We are still dedicated to the success of our clients, both individual and corporate.</p>
          </div>
          <div class="row row-20 justify-content-center justify-content-lg-between">
            <div class="col-md-10 col-lg-6 wow fadeIn"><img class="img-bordered" src="images/index-1-2-570x352.jpg" alt="" width="570" height="352"/>
            </div>
            ...
            <div class="col-md-12 col-lg-4 wow fadeIn">
              <blockquote class="quote quote-default">
                ...
                <div class="quote-body">
                  <q class="heading-6">At Dot Bank, we aim to provide top quality banking services to a greater number of individual and corporate customers than any other bank in the USA or abroad. Our clients value data privacy and security of their banking accounts 24/7.</q>
                </div>
              ...
              <div class="row row-fix row-40">
                <div class="col-6 col-md-12">
                  <div class="progress-bar-circle-wrap text-center">
                    <div class="progress-bar-circle" data-value="0.5" data-gradient="#36f1f8" data-empty-fill="#7b59d0" data-size="100" data-thickness="2"><span></span></div>
        ...
        <div class="container text-center">
          ...
          <div class="owl-carousel text-left" data-items="1" data-md-items="2" data-dots="true" data-nav="false" data-stage-padding="0" data-loop="true" data-margin="30" data-mouse-drag="false" data-autoplay="true">
            <blockquote class="quote quote-boxed">
              ...
              <q>I choose Dot Bank because I know they share my values of putting community first. Not only do they make banking easy, I see them out volunteering and investing in our community.</q>
            ...
            <blockquote class="quote quote-boxed">
              ...
              <q>When I needed financial assistance to expand my shop, I went directly to Dot Bank. Securing financing helped us renovate and expand my jewelry shop and attract more clients.</q>
              <div class="quote-author">
          ...
          <div class="row row-flex row-40 number-counter text-left">
            <div class="col-sm-12 col-lg-4 wow fadeIn">
              <div class="text-block-lined">
                ...
                <p>The minimum amount that can be loaded on the card is $100 or equivalent amount in other currency. The maximum amount would be as per Dot Bank guidelines applicable from time to time. You can learn more about it by contacting our consultants using the form on our website or by calling us directly.</p>
      ...
      <section class="section section-lg bg-gray-100">
        <div class="container text-center">
          ...
          <div class="button-wrap-lg"><a class="button button-lg button-primary" href="masonry-blog.html">View All Blog Posts</a></div>
        </div>
      </section>
      <!-- Pricing-->
      <section class="section section-lg">
          ...
          <div class="row no-gutters justify-content-center">
            <div class="col-md-4">
              <div class="price-box-1">
                ...
                <div class="heading-3 price">Free</div><a class="button button-lg button-primary" href="#">Book a Card</a>
              </div>
            </div>
            <div class="col-md-4">
              <div class="price-box-1 price-box-1-primary">
                ...
                <div class="heading-3 price">$99.00/mo</div><a class="button button-lg button-primary" href="#">Book a Card</a>
              </div>
            </div>
            <div class="col-md-4">
              <div class="price-box-1">
                ...
                <p class="exeption">This card from Dot Bank proved to be a great financial solution for big companies and international enterprises worldwide.</p>
                <div class="heading-3 price">$199.00/mo</div><a class="button button-lg button-primary" href="#">Book a Card</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer class="section footer-2">
        <div class="container">
          <div class="row row-40">
            <div class="col-md-6 col-lg-3"><a class="footer-logo" href="index.html"><img src="images/logo-white-145x40.png" alt="" width="145" height="40"/></a>
              <p>Dot Bank is the leading financial establishment providing high-quality international banking services. We are always ready to partner with you by offering full financial support to individuals and companies worldwide.</p>
            </div>
            <div class="col-md-6 col-lg-3">
