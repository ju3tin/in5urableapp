...
?>
      ...
      <section class="section section-lg">
        <div class="container">
          <ul class="list-xxl-2">
            <li class="row row-30 flex-row-reverse justify-content-around justify-content-xl-between">
              <div class="col-md-6 col-lg-5 col-xl-6"><img src="images/single-project-1-553x442.png" alt="" width="553" height="442"/>
              </div>
              <div class="col-md-6 col-lg-5 col-xl-5">
                <div class="text-block-4">
                  <h2>Overview</h2>
                  <h6>Lorem ipsum dolor sit amet, scripta legimus quaerendum ex vis, audire nonumes his an. Decore tamquam insolens usu, an duo.</h6>
                  <p>Lorem ipsum dolor sit amet, scripta legimus quaerendum ex vis, audire nonumes his an. Decore tamquam insolens usu, an duo omnium debitis adipiscing, ne postulant. Lorem ipsum dolor sit amet, scripta legimus quaerendum ex vis, audire nonumes his an. Decore tamquam insolens usu, an duo omnium debitis adipiscing, ne postulant.</p>
                </div>
              </div>
            </li>
            <li class="row row-30 justify-content-around justify-content-xl-between">
              <div class="col-md-6 col-lg-5 col-xl-7"><img class="img-bordered" src="images/single-project-2-640x440.jpg" alt="" width="640" height="440"/>
              </div>
            ...
            <li class="row row-30 flex-row-reverse justify-content-around justify-content-xl-between">
              <div class="col-md-6 col-lg-5 col-xl-7"><img src="images/single-project-3-619x162.png" alt="" width="619" height="162"/>
              </div>
              <div class="col-md-6 col-lg-5 col-xl-4">
                <p>Lorem ipsum dolor sit amet, scripta legimus quaerendum ex vis, audire nonumes his an. Decore tamquam insolens usu, an duo omnium debitis adipiscing, ne postulant. Lorem ipsum dolor sit amet, scripta legimus quaerendum ex vis, audire nonumes his an. Decore tamquam insolens usu, an duo omnium debitis adipiscing, ne postulant.</p>
              </div>
            </li>
            <li class="row row-30 justify-content-center">
      ...
      <section><img class="img-responsive" src="images/single-project-4-1920x872.jpg" alt="" width="1920" height="872"/>
      </section>
      <!-- Page Footer-->
